...
# C-input from Tea
	# 700 kg/acre/month = 1.72974 tons/ha/month = 20.75688 tons/ha/yr

crop_type = "Tea"
proportion_crop = 0.8645
crop_yield = 20.75688     # yields usually already reported as dry matter
moist_content = 1 - 1/4.5	# 4.5 kg of leaves turn into 1 kg of leaves, by drying
harvest_index = 0.2    # ratio of dry-yield : total dry aboveground biomass
rs_ratio = 0.2

C_P = crop_yield * carbon_content * (1 - moist_content)
S_P = 0

C_S = (C_P * 1/harvest_index - C_P)
S_S = 0.1 # pruned every 2 yrs or so, return rate to soil is an estimate, no hard data found

C_R = (C_S + C_P)* rs_ratio
S_R = 0.3 # approximately 30% of root biomass is delivered to SOC

C_E = (C_P + C_S + C_R) * (root_exudate_ratio)
S_E = 0.3 # approximately 30% of root biomass is delivered to SOC
