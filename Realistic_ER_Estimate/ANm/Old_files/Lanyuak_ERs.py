...
crop_type = "Maize"
proportion_crop = 0.2
crop_yield = 0.607      # yields usually already reported as dry matter
moist_content = 0.13
...
crop_type = "Wheat"
proportion_crop = 0.15
crop_yield = 0.526      # yields usually already reported as dry matter
moist_content = 0.13
harvest_index = 0.48    # ratio of dry-yield : total dry aboveground biomass
rs_ratio = 0.1
